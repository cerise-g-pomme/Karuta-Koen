...
var drop_smoothed=math_ease(clamp((1-drop_value)*1.5,0,1));
drop_value=max(0,drop_value*0.8);
if (drop_value>0.01)karuta_draw(center_x,center_y,scale,choose_old,1);
karuta_draw(center_x+100*scale*drop_value*drop_x,center_y-300*scale*drop_value,scale,choose_poem,drop_smoothed);
